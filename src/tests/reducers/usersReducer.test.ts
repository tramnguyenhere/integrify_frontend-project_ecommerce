...
describe('usersReducer', () => {
  ...
  test('create new user ok', async () => {
    const createUser = {
      ...
      password: "123456",
      avatar: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FGitHub&psig=AOvVaw1y5Ey0pb7i_cnnd6qlfEWF&ust=1684862933277000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCPDNode5if8CFQAAAAAdAAAAABAE"
    }
